...
BLOG_AUTHOR = "Tobias Budig"  # (translatable)
BLOG_TITLE = "Tobias Budig"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://tobias-budig.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://karllorey.com/"
BLOG_EMAIL = "hello@tobias-budig.com"
BLOG_DESCRIPTION = "Personal website of Tobias Budig"  # (translatable)
...
# relative URL.
#
# If you don't need any of these, just set to []  <--------------------------- Change here
REDIRECTIONS = [
 #   (
